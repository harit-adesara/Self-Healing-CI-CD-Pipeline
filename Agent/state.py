...
#         )
#     )
#     confidence: int =Field(description="Confidence score for the classification, ranging from 0 to 100.",ge=0, le=100)
#     reason: str
...
class Data(TypedDict):
    ...
    success: bool
    confidence: Optional[float]
    messages: Annotated[list, add_messages]   # <-- reducer added, everything else unchanged
